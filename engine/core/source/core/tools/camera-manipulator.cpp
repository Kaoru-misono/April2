...
#include "camera-manipulator.hpp"
...
namespace april::core
{
    ...
    auto CameraManipulator::setCamera(Camera camera, bool instantSet /*=true*/) -> void
    {
        m_animDone = true;
    ...
    auto CameraManipulator::getLookat(glm::vec3& eye, glm::vec3& center, glm::vec3& up) const -> void
    {
        eye    = m_current.eye;
    ...
    auto CameraManipulator::pan(glm::vec2 displacement) -> void
    {
        if (m_mode == Fly)
        {
            displacement *= -1.f;
    ...
    //
    auto CameraManipulator::orbit(glm::vec2 displacement, bool invert /*= false*/) -> void
    {
    ...
    //
    auto CameraManipulator::dolly(glm::vec2 displacement, bool keepCenterFixed /*= false*/) -> void
    {
    ...
    //   over time.
    auto CameraManipulator::updateAnim() -> void
    {
    ...
    auto CameraManipulator::setFov(float fovDegree) -> void
    {
        m_current.fov = std::min(std::max(fovDegree, 0.01f), 179.0f);
    }

    auto CameraManipulator::computeBezier(float t, glm::vec3& p0, glm::vec3& p1, glm::vec3& p2) -> glm::vec3
    {
        float u  = 1.f - t;
        float tt = t * t;
        float uu = u * u;
    ...
    auto CameraManipulator::findBezierPoints() -> void
    {
    ...
    //
    auto CameraManipulator::getSystemTime() -> double
    {
    ...
    auto CameraManipulator::Camera::getString() const -> std::string
    {
        return std::format("{{{}, {}, {}}}, {{{}, {}, {}}}, {{{}, {}, {}}}, {{{}}}, {{{}, {}}}", //
                           eye.x, eye.y, eye.z,                                                   //
                           ctr.x, ctr.y, ctr.z,                                                   //
