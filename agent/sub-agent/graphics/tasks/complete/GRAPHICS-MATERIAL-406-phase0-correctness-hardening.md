...
evidence: "build: cmake --build build/vs2022 --config Debug --target April_asset April_graphics April_scene (passed)"
---
...
## Acceptance Criteria
- [x] Material type is loaded from asset metadata, not path parsing.
- [x] Missing material type conformance is detected before shader link and reported clearly.
- [x] Existing Standard/Unlit scene path remains functional with no path-based branching.
