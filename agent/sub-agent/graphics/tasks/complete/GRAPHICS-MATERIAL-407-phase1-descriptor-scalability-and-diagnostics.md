...
evidence: "build: cmake --build build/vs2022 --config Debug --target April_graphics April_scene April_editor (passed)"
---
...
## Acceptance Criteria
- [x] Descriptor table capacities are configured by host defines and synchronized across shaders/host bind path.
- [x] Descriptor overflow behavior is deterministic and visible in diagnostics.
- [x] Inspector/debug surface shows material and descriptor usage stats.
