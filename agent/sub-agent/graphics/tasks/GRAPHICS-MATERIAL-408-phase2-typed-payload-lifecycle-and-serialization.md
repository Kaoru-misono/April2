...
## Acceptance Criteria
- [ ] Material data model no longer forces all types into `StandardMaterialData` payload.
- [ ] MaterialSystem supports selective updates based on per-material change flags.
- [ ] At least one material type supports parameter serialize/deserialize round-trip.
