...
- **Game Editor Foundation:** A modular, professional-grade editor built with Dear ImGui, featuring a docking workspace, high-level UI components (Camera, Tonemapper, Property Editor), offscreen viewport rendering, and a high-performance multi-threaded CPU/GPU Profiler with Chrome Tracing export.
