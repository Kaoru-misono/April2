...
- **Game Editor Foundation:** A modular, professional-grade editor built with Dear ImGui, featuring a docking workspace, high-level UI components (Camera, Tonemapper, Property Editor), and offscreen viewport rendering.
